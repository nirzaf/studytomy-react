      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-gray-600">
                Homeschooling's definition varies among individuals, but it broadly refers
                to the education of a child outside the conventional school system by a
                parent, guardian, or tutor. A student can be homeschooled with either a
                physical or online tutor.
              </p>
              <p className="text-gray-600">
                This occurs on a full-time basis, as all children are legally required 
                to receive a full-time education from the age of five. The legal age for 
                full-time education may vary from country to country.
              </p>
              <p className="text-gray-600">
                There is no one-size-fits-all approach to homeschooling. The philosophies,
                educational structures, and curriculum are decided by the parent and child,
                with the child's growth and progress being the primary focus.
              </p>
            </motion.div>
          </div>
        </div>
